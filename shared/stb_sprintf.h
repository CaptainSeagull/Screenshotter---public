...
// JL: Mirror didn't like silly C types like unsigned long long. Should update at some point but just wanted to get this working.
#include <stdint.h>
...
#define STBSP__NUMSZ   512 // big enough for e308 (with commas) or e-307 
            ...
            hexfloat:
                ...
                // sign
                lead[0] = 0; if (fl & STBSP__NEGATIVE) {
                    lead[0] = 1;
                    lead[1] = '-';
            ...
            dosmallfloat:
                ...
                n = pr;
                if ( l > (stbsp__uint32)pr ) l = pr; while ((l > 1) && (pr) && (sn[l - 1] == '0')) {
                    --pr;
                    --l;
                }
            ...
            dofloatfromg:
                ...
                if (dp <= 0) {
                    ...
                    *s++ = '0'; if (pr) *s++ = stbsp__period;
                    n = -dp; if((stbsp__int32)n > pr) n = pr; i = n; while(i) {
                    ...
                    if ((stbsp__int32)(l + n) > pr) l = pr - n; i = l; while(i) {
                        *s++ = *sn++;
                        --i;
                    }
                    tz = pr - (n + l);
            ...
            case 'd': // integer
                ...
                if ( fl & STBSP__INTMAX ) {
                    stbsp__int64 i64 = va_arg(va, stbsp__int64); n64 = (stbsp__uint64)i64; if ((f[0] != 'u') && (i64 < 0)) {
                        n64 = (stbsp__uint64) - i64;
                        fl |= STBSP__NEGATIVE;
                    }
                } else {
                    stbsp__int32 i = va_arg(va, stbsp__int32); n64 = (stbsp__uint32)i; if ((f[0] != 'u') && (i < 0)) {
                        n64 = (stbsp__uint32) - i;
                        fl |= STBSP__NEGATIVE;
                    }
                }
                ...
                // get the length that we copied
                l = (stbsp__uint32) ( (num + STBSP__NUMSZ) - s ); if ( l == 0 ) {
                    *--s = '0';
                    l = 1;
                }
                cs = l + (3 << 24);
...
#define stbsp__ddmultlos(oh,ol,xh,yl) \
    ...
    static stbsp__int32 stbsp__real_to_str( char const * * start, stbsp__uint32 *len, char *out, stbsp__int32 *decimal_pos, double value, stbsp__uint32 frac_digits ) {
        ...
        if ( ( frac_digits < 24 ) ) {
            stbsp__uint32 dg = 1; if ((stbsp__uint64)bits >= stbsp__powten[9] ) dg = 10; while( (stbsp__uint64)bits >= stbsp__powten[dg] ) {
                ++dg;
