...
void* memory_push_internal(Memory * memory , uintptr_t buffer_index , uintptr_t size , char * fname , int line , uintptr_t alignment  );
...
Memory_Group* get_memory_group(Memory * memory , uintptr_t buffer_index );
void* memory_push_internal(Memory * memory , uintptr_t buffer_index , uintptr_t size , char * file , int line , uintptr_t alignment );
void memory_pop(Memory * memory , void * memory_buffer );
void memory_clear_entire_group(Memory * memory , uintptr_t buffer_index );
...
float square_root(float a );
 ...
 static Image_Letter_Result make_letter_image(Memory * memory , stbtt_fontinfo * font , Char ch );
