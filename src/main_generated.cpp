...
static uint64_t type_to_size(Type type) {
    switch(type) {
        ...
        case Type_stbtt_pack_context: { return(sizeof(stbtt_pack_context)); } break;
        case Type_stbtt_fontinfo: { return(sizeof(stbtt_fontinfo)); } break;
        case Type_stbrp_rect: { return(sizeof(stbrp_rect)); } break;
        case Type_stbtt_kerningentry: { return(sizeof(stbtt_kerningentry)); } break;
        ...
        case Type_DLL_Data: { return(sizeof(DLL_Data)); } break;
    }
    return(0);
}
static Type string_to_type(char const *s, uint64_t l) {
    ...
    else if(sgl_generated_string_compare("stbtt_pack_context", 18, s, l)) { return(Type_stbtt_pack_context); }
    else if(sgl_generated_string_compare("stbtt_fontinfo", 14, s, l)) { return(Type_stbtt_fontinfo); }
    else if(sgl_generated_string_compare("stbrp_rect", 10, s, l)) { return(Type_stbrp_rect); }
    else if(sgl_generated_string_compare("stbtt_pack_context", 18, s, l)) { return(Type_stbtt_pack_context); }
    else if(sgl_generated_string_compare("stbtt_fontinfo", 14, s, l)) { return(Type_stbtt_fontinfo); }
    else if(sgl_generated_string_compare("stbtt_kerningentry", 18, s, l)) { return(Type_stbtt_kerningentry); }
    ...
    else if(sgl_generated_string_compare("Image_Letter_Result", 19, s, l)) { return(Type_Image_Letter_Result); }
    else if(sgl_generated_string_compare("Entry", 5, s, l)) { return(Type_Entry); }
    else if(sgl_generated_string_compare("DLL_Data", 8, s, l)) { return(Type_DLL_Data); }
    return(Type_unknown);
}
